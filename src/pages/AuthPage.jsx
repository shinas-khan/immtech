...
export default function AuthPage() {
  ...
  const inp = {
    ...
    padding: "12px 14px", fontSize: 14, color: "#0A0F1E",
    background: "#F8FAFF", fontFamily: "inherit", outline: "none",
    transition: "border-color 0.2s"
  }

  return (
    <div style={{ minHeight: "100vh", background: "#F8FAFF", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 20px" }}>
      <div style={{ background: "#fff", border: "1px solid #E8EEFF", borderRadius: 24, padding: "48px 44px", width: "100%", maxWidth: 460, boxShadow: "0 20px 60px rgba(0,57,255,0.07)" }}>
        ...
        <h1 style={{ fontSize: 26, fontWeight: 900, color: "#0A0F1E", margin: "0 0 6px", letterSpacing: -0.8 }}>
          {mode === "signin" ? "Welcome back" : "Create your account"}
        </h1>
        <p style={{ color: "#4B5675", fontSize: 15, margin: "0 0 28px" }}>
          {mode === "signin" ? "Sign in to continue your job search" : "Start finding visa-sponsored jobs today"}
        </p>

        <button onClick={handleGoogle} style={{ display: "none", width: "100%", background: "#fff", border: "1.5px solid #E8EEFF", borderRadius: 12, padding: "13px", fontSize: 15, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 20, color: "#0A0F1E", fontFamily: "inherit", transition: "border-color 0.2s" }}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }}>
          ...
          <span style={{ color: "#9CA3B8", fontSize: 13 }}>or</span>
          <div style={{ flex: 1, height: 1, background: "#E8EEFF" }} />
        </div>

        {mode === "signup" && (
          <div style={{ marginBottom: 14 }}>
            <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "#4B5675", marginBottom: 6, textTransform: "uppercase", letterSpacing: 0.7 }}>Full Name</label>
        ...
        <div style={{ marginBottom: 14 }}>
          <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "#4B5675", marginBottom: 6, textTransform: "uppercase", letterSpacing: 0.7 }}>Email</label>
        ...
        <div style={{ marginBottom: 22 }}>
          <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "#4B5675", marginBottom: 6, textTransform: "uppercase", letterSpacing: 0.7 }}>Password</label>
        ...
        <button onClick={handleEmailAuth} disabled={loading} style={{ width: "100%", background: "linear-gradient(135deg, #0057FF, #00C2FF)", color: "#fff", border: "none", borderRadius: 12, padding: "14px", fontSize: 15, fontWeight: 700, cursor: "pointer", fontFamily: "inherit", boxShadow: "0 4px 18px #0057FF30", opacity: loading ? 0.75 : 1, marginBottom: 20 }}>
