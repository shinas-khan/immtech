...
const HARD_NEGATIVES = [
  ...
  // Exact phrases from real job descriptions
  "this post will not be open to sponsorship under the ukvi scheme",
  "this post will not be open to sponsorship under ukvi",
  "not open to sponsorship under the ukvi scheme",
  "not open to sponsorship under ukvi",
  "we are unable to accept applicants with skilled worker visa",
  "unable to accept applicants with skilled worker visas",
  "we are unable to accept applicants without skilled worker visa",
  "only accept applications from candidates who are located in and eligible to work",
  "candidates who are located in and eligible to work within the uk",
  "we can only accept applications from candidates who are located in",
  ...
  "cannot support a visa application",
  ...
  "you must have current right to work",
  "applicants must be eligible to work in the uk",
  "all applicants must have the right to work",
  "have the right to work in the uk before",
  "valid right to work in uk",
  "must provide proof of right to work",
  "this position is not eligible for sponsorship",
  "this vacancy is not eligible for sponsorship",
  "unfortunately this role is not eligible for sponsorship",
  "we are unable to offer ukvi sponsorship",
  "ukvi sponsorship will not be available",
  "sponsorship cannot be provided",
  "applicants requiring sponsorship need not apply",
  "candidates requiring sponsorship should not apply",
  ...
  "uk classroom experience required",
  ...
  "right to work check will be required",
